...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-40 w-full border-b border-[#FFD94A]/15 bg-[#050A14]/90 backdrop-blur-md">
        ...
        <div className="flex h-20 items-center justify-between gap-3">
          ...
          <div className="flex items-center shrink-0">
            <Link href="/" className="flex items-center space-x-2.5 group">
              <Logo size={32} />
              <span className="hidden 2xl:block font-display font-bold text-base tracking-wide text-white uppercase group-hover:text-[#FFD94A] transition-colors whitespace-nowrap">
                The Sector of Collectives
              </span>
              <span className="2xl:hidden font-display font-bold text-base tracking-wide text-white uppercase group-hover:text-[#FFD94A] transition-colors whitespace-nowrap">
                The Sector
              </span>
            </Link>
          </div>
              ...
              {navLinks.map((link) => (
                <Link
                  ...
                  className={`px-2 py-2 rounded-md text-[0.8rem] font-semibold transition-all duration-150 whitespace-nowrap underline-offset-4 decoration-2 ${
                    isActive(link.href)
                      ? "text-[#FFD94A] underline decoration-[#FFD94A]"
          ...
          <div className="hidden xl:flex items-center shrink-0">
            <button
              ...
              className="inline-flex items-center justify-center rounded-lg bg-[#FFD94A] hover:bg-[#FFAA2A] text-[#050A14] px-4 py-2.5 text-[0.8rem] font-extrabold shadow-md hover:shadow-[#FFD94A]/25 transition-all cursor-pointer uppercase tracking-wider whitespace-nowrap"
            >
              Book Strategy Call
            </button>
          </div>
      ...
      {isMobileMenuOpen && (
        <div className="xl:hidden bg-[#050A14] border-b border-[#FFD94A]/15">
          <div className="space-y-1 px-3 pt-2 pb-4">
            ...
            <div className="pt-4 px-3 flex flex-col gap-2">
              <button
                ...
                className="w-full text-center bg-[#FFD94A] hover:bg-[#FFAA2A] text-[#050A14] font-extrabold py-3 px-4 rounded-lg text-sm transition-all cursor-pointer uppercase tracking-wider"
              >
                Book Strategy Call
              </button>
            </div>
