  ...
  const screens: SoftwareScreen[] = [
    {
      ...
      mockupContent: (
        <div className="w-full h-full bg-[#120b06] text-white p-4 font-mono text-[9px] flex flex-col justify-between">
          ...
          {/* Active Queue Table */}
          <div className="mt-3 flex-1 bg-[#18100a] border border-amber-900/20 rounded p-2 overflow-hidden">
            <div className="flex justify-between border-b border-amber-900/20 pb-1 mb-1 text-[7px] text-stone-500 uppercase font-black">
      ...
      mockupContent: (
        <div className="w-full h-full bg-[#120b06] text-white p-4 font-mono text-[9px] flex flex-col justify-between">
          ...
          <div className="grid grid-cols-2 gap-4 flex-1 pt-1">
            <div className="space-y-2 bg-[#18100a] p-2.5 rounded border border-amber-900/10">
      ...
      mockupContent: (
        <div className="w-full h-full bg-[#120b06] text-white p-4 font-mono text-[9px] flex flex-col justify-between">
          ...
          <div className="space-y-2.5 flex-1 pt-1">
            <div className="flex justify-between bg-[#18100a] p-2 rounded border border-amber-900/10 items-center">
              <div>
            ...
            <div className="bg-[#18100a] p-2.5 rounded border border-amber-900/10 space-y-1.5">
  ...
  return (
    <div className="w-full max-w-5xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center bg-[#18100a]/40 border border-amber-900/30 rounded-2xl p-6 md:p-8 backdrop-blur-md">
        ...
        {/* Browser Mockup */}
        <div className="lg:col-span-8 w-full border border-amber-900/40 rounded-xl overflow-hidden bg-[#18100a] shadow-xl">
