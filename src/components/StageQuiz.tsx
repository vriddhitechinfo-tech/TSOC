      ...
      {step < questions.length ? (
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <span className="text-[9px] font-bold uppercase tracking-widest text-[#d4af37] bg-amber-955/30 border border-amber-900/40 px-2 py-0.5 rounded">
          ...
          <div className="space-y-3">
            {questions[step].options.map((opt, i) => (
              <button
                ...
                className="w-full text-left p-4 rounded-lg bg-[#120b06]/40 border border-amber-900/20 hover:border-amber-500/40 text-xs sm:text-sm text-stone-300 hover:text-white transition-all duration-200 cursor-pointer flex items-center justify-between group focus:outline-none focus:ring-1 focus:ring-[#d4af37]"
              >
                <span>{opt.label}</span>
                <span className="h-5 w-5 rounded bg-amber-950/40 border border-amber-900/50 flex items-center justify-center text-[#d4af37] opacity-0 group-hover:opacity-100 transition-opacity">
        ...
        <div className="space-y-6 animate-fade-in text-center py-4">
          <div className="h-12 w-12 rounded-full bg-emerald-500/10 border border-emerald-500/30 flex items-center justify-center text-[#d4af37] mx-auto mb-4 animate-bounce">
          ...
          <div className="space-y-2">
            ...
            <h3 className="text-base sm:text-lg font-black text-white pt-2">
              Recommended Stage: <span className="text-[#d4af37]">{getRecommendation().title}</span>
            </h3>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-6">
            <Link
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center rounded-lg bg-gradient-to-r from-[#d4af37] to-[#f59e0b] hover:from-[#c29e2f] hover:to-[#e08d03] text-black px-6 py-3 text-xs font-extrabold shadow-md uppercase tracking-wider transition-all"
            >
