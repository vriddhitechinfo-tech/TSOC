...
export default function FeeCalculator() {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto bg-[#1C0F0A]/50 border border-[#FF9F76]/20 rounded-2xl overflow-hidden shadow-2xl backdrop-blur-md">
      <div className="grid grid-cols-1 lg:grid-cols-2">
        {/* Left Side: Inputs */}
        <div className="p-6 md:p-8 space-y-6">
          <div className="space-y-2">
            <span className="text-xs font-bold uppercase tracking-widest text-[#FF9F76] bg-[#FF9F76]/10 border border-[#FF9F76]/40 px-3 py-1 rounded">
              Revenue Simulator
            </span>
          ...
          <div className="space-y-5 pt-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between text-xs font-semibold text-[#EDE9E0]/70">
                ...
                <span className="text-[#FF9F76] font-mono text-sm font-black">{returns}</span>
              </div>
              <input
                type="range"
                id="calc-returns"
                ...
                className="w-full h-1 bg-[#2A160E] rounded-lg appearance-none cursor-pointer accent-[#FF9F76]"
              />
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between text-xs font-semibold text-[#EDE9E0]/70">
                ...
                <span className="text-[#FF9F76] font-mono text-sm font-black">${avgCharge}</span>
              </div>
              <input
                type="range"
                id="calc-charge"
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between text-xs font-semibold text-[#EDE9E0]/70">
                ...
                <span className="text-[#FF9F76] font-mono text-sm font-black">{splitPercent}%</span>
              </div>
              <input
                type="range"
                id="calc-split"
        ...
        {/* Right Side: Results */}
        <div className="bg-[#2A160E]/60 border-t lg:border-t-0 lg:border-l border-[#FF9F76]/20 p-6 md:p-8 flex flex-col justify-between space-y-6">
          <div className="space-y-4">
            <div>
              <span className="text-xs font-bold uppercase tracking-widest text-[#FF9F76]">Total Annual Revenue</span>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-[#1C0F0A]/40 border border-[#FF9F76]/15 p-3 rounded-lg">
              ...
              <div className="bg-[#1C0F0A]/40 border border-[#FF9F76]/15 p-3 rounded-lg">
                <span className="text-xs font-bold text-[#FF9F76] uppercase tracking-wider block">Independent ERO Income</span>
            ...
            {/* Savings Highlight */}
            <div className="bg-[#FF9F76]/5 border border-[#FF9F76]/25 p-4 rounded-xl space-y-1">
              <span className="text-xs font-bold uppercase tracking-widest text-[#FF9F76] block">Estimated Revenue Increase</span>
              <div className="text-2xl sm:text-3xl font-black text-[#FF9F76] font-mono leading-none">
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full inline-flex items-center justify-center rounded-lg bg-[#FF9F76] hover:bg-[#F4845F] text-[#140A06] py-3 text-xs font-extrabold uppercase tracking-wider shadow-md hover:shadow-[#FF9F76]/10 transition-all cursor-pointer"
            >
              Get Your EFIN &amp; Keep 100%
              <ArrowRight className="w-3.5 h-3.5 ml-2" />
            </button>
            <div className="flex items-center justify-center space-x-1.5 text-xs text-[#EDE9E0]/50">
              <ShieldCheck className="w-3.5 h-3.5 text-[#FF9F76] shrink-0" />
