    ...
    <div ref={pageRef} className="relative overflow-hidden bg-[#0A0908] min-h-screen py-16 sm:py-10 animate-fade-in">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            return (
              <TiltCard key={op.name} delay={(i % 4) * 0.08} className="glass-card glass-card-hover p-6 flex flex-col justify-between min-h-[220px]">
                ...
                <div className="pt-4 mt-4">
                  <button
                    onClick={() => openModal("strategy")}
                    className="text-xs font-bold text-[#EDE9E0]/40 hover:text-[#FFB26A] flex items-center gap-1 uppercase tracking-wider transition-colors cursor-pointer"
                  >
                    Setup Service
        ...
        <TiltCard tilt={3} className="glass-card p-8 md:p-12 mb-24 grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
          ...
          <div className="space-y-2 border-y md:border-y-0 md:border-x border-[#FFB26A]/10 py-6 md:py-0 md:px-8">
        ...
        <div className="gsap-reveal text-center max-w-xl mx-auto mt-16 space-y-4">
          ...
          <button
            onClick={() => openModal("strategy")}
            className="bg-[#FFB26A] hover:bg-[#F4845F] text-[#140A06] font-extrabold py-3 px-8 rounded-lg text-xs transition-all shadow-md cursor-pointer uppercase tracking-wider"
          >
