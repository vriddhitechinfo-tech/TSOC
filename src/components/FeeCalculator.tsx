      ...
      <div className="grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="p-6 md:p-8 space-y-6">
          <div className="space-y-2">
            <span className="text-[9px] font-bold uppercase tracking-widest text-[#FFD94A] bg-[#FFD94A]/10 border border-amber-900/40 px-3 py-1 rounded">
              Revenue Simulator
            </span>
        ...
        {/* Right Side: Results */}
        <div className="bg-[#24160f]/60 border-t lg:border-t-0 lg:border-l border-[#FFD94A]/20 p-6 md:p-8 flex flex-col justify-between space-y-6">
          <div className="space-y-4">
            <div>
              <span className="text-[9px] font-bold uppercase tracking-widest text-[#FFD94A]">Total Annual Revenue</span>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="bg-[#120b06]/40 border border-amber-900/15 p-3 rounded-lg">
                <span className="text-[8px] font-bold text-[#FFD94A] uppercase tracking-wider block">Independent ERO Income</span>
            ...
            <div className="bg-[#FFD94A]/5 border border-[#FFD94A]/25 p-4 rounded-xl space-y-1">
              <span className="text-[8px] font-bold uppercase tracking-widest text-[#FFD94A] block">Estimated Revenue Increase</span>
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full inline-flex items-center justify-center rounded-lg bg-gradient-to-r from-[#FFD94A] to-[#FFAA2A] hover:from-[#c29e2f] hover:to-[#e08d03] text-black py-3 text-xs font-extrabold uppercase tracking-wider shadow-md hover:shadow-[#FFD94A]/10 transition-all cursor-pointer"
            >
