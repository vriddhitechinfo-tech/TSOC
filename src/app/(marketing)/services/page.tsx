            ...
            >
              <div className="space-y-3 flex-1">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-xs font-bold text-[#EDE9E0]/60 uppercase tracking-widest bg-[#1C2A47] border border-[#FF9F76]/30 px-2.5 py-0.5 rounded">
                    {srv.tag}
                  </span>
                </div>
              ...
              <div className="shrink-0">
                <Link
                  href={srv.href}
                  className="inline-flex items-center gap-1.5 bg-[#1C2A47] hover:bg-[#FF9F76] border border-[#FF9F76]/30 text-[#FF9F76] hover:text-[#050A14] px-5 py-2.5 rounded-lg text-xs font-extrabold transition-all uppercase tracking-wider"
                >
                  View Details
