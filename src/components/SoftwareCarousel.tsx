      ...
      mockupContent: (
        <div className="w-full h-full bg-[#0d1526] text-white p-4 font-mono text-xs flex flex-col justify-between">
          <div className="flex items-center justify-between border-b border-[#FFD94A]/15 pb-2 mb-3">
            ...
            <span className="bg-[#FFD94A] text-[#FFD94A] px-1.5 py-0.5 rounded text-xs font-bold border border-[#FFD94A]/35">ACTIVE SEASON</span>
          </div>
          ...
          <div className="grid grid-cols-3 gap-2">
            ...
            <div className="bg-[#0d1526] border border-[#FFD94A]/15 p-2 rounded">
              ...
              <span className="text-base font-black text-[#FFD94A] font-sans">99.2%</span>
            </div>
            <div className="bg-[#0d1526] border border-[#FFD94A]/15 p-2 rounded">
          ...
          <div className="mt-3 flex-1 bg-[#0d1526] border border-[#FFD94A]/15 rounded p-2 overflow-hidden">
            <div className="flex justify-between border-b border-[#FFD94A]/15 pb-1 mb-1 text-[7px] text-[#EDE9E0]/50 uppercase font-black">
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between text-[#EDE9E0]/70">
                ...
                <span className="text-[#FFD94A] font-bold">ACCEPTED</span>
              ...
              <div className="flex justify-between text-[#EDE9E0]/70">
                ...
                <span className="text-[#FFD94A] font-bold">TRANSMITTED</span>
                <span>HOLD</span>
              </div>
            </div>
          </div>
      ...
      mockupContent: (
        <div className="w-full h-full bg-[#0d1526] text-white p-4 font-mono text-xs flex flex-col justify-between">
          ...
          <div className="grid grid-cols-2 gap-4 flex-1 pt-1">
            ...
            <div className="space-y-2 bg-[#FFD94A]/10 p-2.5 rounded border border-[#FFD94A]/25">
              <span className="text-[#FFD94A] uppercase text-[7px] font-bold block">Real-time Diagnostics</span>
              <div className="space-y-1.5 text-[#EDE9E0]/70">
                ...
                <div className="flex items-center space-x-1.5">
                  <span className="h-1.5 w-1.5 rounded-full bg-[#FFD94A] shrink-0 animate-pulse" />
        ...
        <div className="w-full h-full bg-[#0d1526] text-white p-4 font-mono text-xs flex flex-col justify-between">
          ...
          <div className="flex items-center justify-around py-4">
            <div className="flex flex-col items-center space-y-1">
              <div className="h-6 w-6 rounded-full bg-[#FFD94A] border border-[#FFD94A] flex items-center justify-center text-[#FFD94A] font-bold">✓</div>
              <span className="text-[7px] text-[#EDE9E0]/60">Transmitted</span>
            </div>
            <div className="h-0.5 w-10 bg-[#FFD94A]" />
            <div className="flex flex-col items-center space-y-1">
              <div className="h-6 w-6 rounded-full bg-[#FFD94A] border border-[#FFD94A] flex items-center justify-center text-[#FFD94A] font-bold">✓</div>
      ...
      mockupContent: (
        <div className="w-full h-full bg-[#0d1526] text-white p-4 font-mono text-xs flex flex-col justify-between">
          <div className="flex items-center justify-between border-b border-[#FFD94A]/15 pb-2 mb-2">
            ...
            <span className="text-[#FFD94A] font-bold uppercase text-[7px]">Direct Connect API</span>
          </div>
          ...
          <div className="space-y-2.5 flex-1 pt-1">
            <div className="flex justify-between bg-[#0d1526] p-2 rounded border border-[#FFD94A]/10 items-center">
              ...
              <span className="text-[#FFD94A] font-bold">ENABLED</span>
            </div>
            ...
            <div className="bg-[#0d1526] p-2.5 rounded border border-[#FFD94A]/10 space-y-1.5">
              ...
              <div className="flex justify-between pt-0.5 text-white font-bold">
                ...
                <span className="text-[#FFD94A]">$5,350.00</span>
              </div>
            </div>
          </div>
        </div>
    ...
    <div className="w-full space-y-6">
        ...
        {screens.map((s, i) => (
          <button
            ...
            style={{
              ...
              backgroundColor: i === activeIndex ? "#FFD94A" : "rgba(255,217,74,0.15)",
            }}
          />
        ))}
      </div>
      ...
      <div className="relative">
        ...
        >
          {screens.map((screen, i) => (
            <div
              ...
              className="snap-center shrink-0 w-[88%] sm:w-[78%] lg:w-[70%] grid grid-cols-1 lg:grid-cols-12 gap-8 items-center bg-[#0d1526]/40 border border-[#FFD94A]/30 rounded-2xl p-6 md:p-8 backdrop-blur-md"
            >
              <div className="lg:col-span-4 space-y-4 text-center lg:text-left">
                <span className="inline-flex items-center justify-center h-7 w-7 rounded bg-[#FFD94A]/10 border border-[#FFD94A]/20 text-[#FFD94A] font-black text-xs">
                  0{i + 1}
                </span>
              ...
              <div className="lg:col-span-8 w-full border border-[#FFD94A]/20 rounded-xl overflow-hidden bg-[#0d1526] shadow-xl">
                <div className="bg-[#0d1526] px-4 py-2.5 border-b border-[#FFD94A]/35 flex items-center space-x-1.5">
                  <span className="w-2.5 h-2.5 rounded-full bg-[#FFD94A]/40 inline-block" />
                  <span className="w-2.5 h-2.5 rounded-full bg-[#FFD94A]/65 inline-block" />
                  <span className="w-2.5 h-2.5 rounded-full bg-[#FFD94A]/90 inline-block" />
        ...
        <button
          ...
          className="hidden sm:flex absolute left-1 top-1/2 -translate-y-1/2 h-10 w-10 items-center justify-center rounded-full bg-[#0d1526] border border-[#FFD94A]/30 text-[#FFD94A] hover:bg-[#FFD94A]/10 hover:border-[#FFD94A]/60 transition-all disabled:opacity-30 disabled:cursor-not-allowed cursor-pointer z-10"
        >
        ...
        <button
          ...
          className="hidden sm:flex absolute right-1 top-1/2 -translate-y-1/2 h-10 w-10 items-center justify-center rounded-full bg-[#0d1526] border border-[#FFD94A]/30 text-[#FFD94A] hover:bg-[#FFD94A]/10 hover:border-[#FFD94A]/60 transition-all disabled:opacity-30 disabled:cursor-not-allowed cursor-pointer z-10"
        >
