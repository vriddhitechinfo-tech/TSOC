...
export default function StageQuiz() {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto bg-[#2A160E]/40 border border-[#FF9F76]/20 rounded-xl p-6 md:p-8 relative overflow-hidden backdrop-blur-md shadow-lg">
          ...
          <div className="space-y-3">
            {questions[step].options.map((opt, i) => (
              <button
                ...
                className="w-full text-left p-4 rounded-lg bg-[#2A160E]/30 border border-[#FF9F76]/15 hover:border-[#FF9F76]/40 text-xs sm:text-sm text-[#EDE9E0]/70 hover:text-white transition-all duration-200 cursor-pointer flex items-center justify-between group focus:outline-none focus:ring-1 focus:ring-[#FF9F76]/50"
              >
                <span>{opt.label}</span>
        ...
        <div className="space-y-6 animate-fade-in text-center py-4">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-6">
            <Link
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center rounded-lg bg-[#FF9F76] hover:bg-[#F4845F] text-[#140A06] px-6 py-3 text-xs font-extrabold shadow-md uppercase tracking-wider transition-all"
            >
            ...
            <button
              onClick={resetQuiz}
              className="w-full sm:w-auto inline-flex items-center justify-center rounded-lg bg-[#2A160E] border border-[#FF9F76]/20 px-6 py-3 text-xs font-bold text-[#EDE9E0]/60 hover:text-white uppercase tracking-wider transition-all cursor-pointer"
            >
