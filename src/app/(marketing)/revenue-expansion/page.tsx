      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            return (
              <TiltCard key={op.name} delay={(i % 4) * 0.08} className="glass-card glass-card-hover p-6 flex flex-col justify-between min-h-[220px]">
                ...
                <div className="pt-4 mt-4">
                  <button
                    onClick={() => openModal("strategy")}
                    className="text-xs font-bold text-[#EDE9E0]/40 hover:text-[#FF9F76] flex items-center gap-1 uppercase tracking-wider transition-colors cursor-pointer"
                  >
                    Setup Service
        ...
        <TiltCard tilt={3} className="glass-card p-8 md:p-12 mb-24 grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
          <div className="space-y-2">
            <h4 className="text-[#FF9F76] font-black text-2xl font-mono">+$2,500/mo</h4>
          ...
          <div className="space-y-2 border-y md:border-y-0 md:border-x border-[#FF9F76]/10 py-6 md:py-0 md:px-8">
            <h4 className="text-[#FF9F76] font-black text-2xl font-mono">3.5x</h4>
          ...
          <div className="space-y-2 md:pl-8">
            <h4 className="text-[#FF9F76] font-black text-2xl font-mono">75%</h4>
