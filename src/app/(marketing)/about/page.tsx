    ...
    <div ref={pageRef} className="relative overflow-hidden bg-[#140A06] min-h-screen py-16 sm:py-10">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start mb-20">
          ...
          <TiltCard tilt={5} className="relative bg-[#2A160E] border border-[#FF9F76]/30 rounded-xl p-8 md:p-12 text-center space-y-6 overflow-hidden">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <TiltCard className="glass-card glass-card-hover-emerald p-6 space-y-3">
              <div className="h-9 w-9 rounded-md bg-[#2A160E] border border-[#FF9F76]/30 flex items-center justify-center text-[#FF9F76] mb-2">
