...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-40 w-full border-b border-[#FFB26A]/20 bg-[#0A0908]/90 backdrop-blur-md">
        ...
        <div className="flex h-20 items-center justify-between gap-3">
                ...
                <Link
                  ...
                  className={`px-2 py-2 rounded-md text-[0.8rem] font-semibold transition-all duration-150 whitespace-nowrap underline-offset-4 decoration-2 ${
                    isActive(link.href)
                      ...
                      : "text-[#EDE9E0]/60 hover:text-white hover:bg-[#161412]/60"
                  }`}
                >
                  {link.name}
                </Link>
          ...
          <div className="flex xl:hidden">
            <button
              ...
              className="inline-flex items-center justify-center rounded-md p-2 text-[#EDE9E0]/60 hover:text-white hover:bg-[#161412]/60 focus:outline-none"
            >
      ...
      {isMobileMenuOpen && (
        <div className="xl:hidden bg-[#0A0908] border-b border-[#FFB26A]/20">
