...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      {/* Radial Gradient Glow Header */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(255,178,106,0.04)_0%,transparent_60%)] pointer-events-none -z-10" />

      <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-12 relative z-10 h-auto lg:h-[540px]">
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="lg:col-span-7 space-y-6 flex flex-col justify-center">
              ...
              <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl font-semibold tracking-normal text-white uppercase leading-[1.1]">
              ...
              <p className="text-[#EDE9E0]/70 text-xs md:text-sm max-w-xl leading-relaxed">
                {activeSlide.description}
              </p>

              {/* Dynamic Key Stats for current slide */}
              <div className="grid grid-cols-3 gap-4 py-2 border-y border-[#FFB26A]/15 max-w-lg">
                {activeSlide.stats.map((stat) => (
                  <div key={stat.label}>
                    <div
                      className="text-lg md:text-xl font-black font-mono leading-none"
            ...
            <div className="lg:col-span-5 relative h-full flex items-center justify-center">
              <div className="relative w-full h-[320px] sm:h-[400px] lg:h-[480px] rounded-2xl overflow-hidden border border-[#FFB26A]/20 shadow-2xl shadow-black/80 group">
                <Image
