...
export default function TrustSection() {
  return (
    <div className="w-full bg-[#2A160E]/20 border-y border-[#FF9F76]/10 py-12">
          ...
          <div className="flex flex-col items-center md:items-start space-y-2 md:pl-8">
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-3 mt-1">
              {["TPG", "Republic Bank", "Refund Advantage", "Santa Barbara"].map((bank) => (
                <span
                  key={bank}
                  className="bg-[#2A160E]/60 border border-[#FF9F76]/15 text-xs font-bold text-[#EDE9E0]/60 px-2 py-0.5 rounded tracking-wide uppercase"
                >
                  {bank}
                </span>
              ))}
